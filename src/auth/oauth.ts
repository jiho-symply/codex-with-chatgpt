...
function pairingPage(opts: {
  ...
  const scopeLabels: Record<string, string> = {
    ...
    "proposal.write": "Submit isolated patch proposals (cannot modify the repository)",
...
<div class="card">
  ...
  <p class="sub">ChatGPT is requesting repository read access to <strong>${escapedWorkspaceName}</strong>. Patch proposals, when authorized, are stored outside the repository and are never applied automatically:</p>
  <ul>${scopeList}</ul>
